...
router.register(r"schedules", ScheduleModelViewSet, basename="schedules")

urlpatterns = [
    path("", include(router.urls)),
    path("schedules/<int:trainer_id>/", ScheduleModelViewSet.as_view({"get": "list"}), name="schedules-list"),
